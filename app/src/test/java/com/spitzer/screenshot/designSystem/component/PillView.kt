...
import com.spitzer.screenshot.designSystem.component.preview.PillViewPreview
...
class PillViewScreenshotTest {

    @get:Rule
    val composeRule = createComposeRule()
    private val screenshotName = "DesignSystem/PillView/PillView"

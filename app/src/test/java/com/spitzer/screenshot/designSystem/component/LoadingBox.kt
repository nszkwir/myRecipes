...
import com.spitzer.screenshot.designSystem.component.preview.LoadingBoxPreview
...
class LoadingBoxScreenshotTest {

    @get:Rule
    val composeRule = createComposeRule()
    private val screenshotName = "DesignSystem/LoadingBox/LoadingBox"
